...
data class FootballEventsByDate(
    @JsonProperty("events")
    var events: List<Event?>? = null
) {
    data class Event(
        @JsonProperty("aggregatedWinnerCode")
        var aggregatedWinnerCode: Int? = null,
        ...
        var statusTime: StatusTime? = null,
        @JsonProperty("time")
        var time: Time? = null,
